      ...
      <div className='pb-5'>
        <div className="flex justify-between items-center">
          ...
          <div className='relative py-2 group'>
            <img src={assets.menu_icon} alt="Menu icon" className='max-h-5 cursor-pointer' onClick={() => setIsMenuOpen(!isMenuOpen)} />
            <div className={`absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 ${isMenuOpen ? '' : 'hidden'}`}>
      ...
      <div className='flex flex-col'>
        ...
        (
          <div onClick={() => { setSelectedUser(user); setUnseenMessages((prev) => ({ ...prev, [user._id]: 0 })) }}
            onMouseEnter={() => setUnseenMessages((prev) => ({ ...prev, [user._id]: 0 }))}
